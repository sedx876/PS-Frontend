    ...
    <div className="pinkGradient tosBody">
      <h2 className='tosTitle'>
				...
				<p className='tosPara'>These Website Standard Terms And Conditions (these “Terms” or 
					...
					on this webpage, shall govern your use of this website, including 
					all pages within this website (collectively referred to herein 
					below as this “Website”). These Terms apply in full force and 
					effect to your use of this Website and by using this Website, 
					you expressly accept all terms and conditions contained herein 
					in full. You must not use this Website, if you have any objection 
					to any of these Website Standard Terms And Conditions.
				</p>
				...
				<p className='tosPara'>Other than content you own, which you may have opted to include 
					on this Website, under these Terms, PrideSupport and/or its 
				...
				<p className='tosPara'><strong>You are expressly and emphatically restricted from all 
					...
					<br/><br/>
					Certain areas of this Website are restricted from access 
					by you and PrideSupport may further restrict access by 
				...
				<p className='tosPara'>In these Website Standard Terms And Conditions, 
					...
					respect to Your Content, by displaying it, you grant 
					PrideSupport a non-exclusive, worldwide, irrevocable, 
					royalty-free, sublicensable license to use, reproduce, adapt, 
					publish, translate and distribute it in any and all media.
				</p>

				<p className='tosPara'>Your Content must be your own and must not be infringing on any 
					third party’s rights. PrideSupport reserves the right to 
				...
				<p className='tosPara'>This Website is provided “as is,” with all faults, 
					and PrideSupport makes no express or implied representations 
				...
				<p className='tosPara'>In no event shall PrideSupport , nor any of its officers, 
					...
					and PrideSupport , including its officers, directors and 
				...
				<p className='tosPara'>These Terms, including any legal notices and disclaimers 
					...
					between PrideSupport and you in relation to your use of this 
